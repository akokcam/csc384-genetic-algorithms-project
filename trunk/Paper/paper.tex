...
\section{Approach and Implementation}
  ...
  \subsection{Options for the Genetic Algorithm}
    ...
    \subsubsection{Selecting Parameters for the GA}
      ...
      \paragraph{Generation Parameters}
        ...
        \begin{figure}[H]
  		  \centering
  		  \includegraphics[width=6cm]{GAParametersData}
      ...
      \paragraph{Size Parameters}
       [\ldots]  Duis accumsan sagittis velit vel consectetur. Nullam sed ligula nisl. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Morbi quis neque eu justo accumsan auctor. Cras a risus ac est aliquam malesuada quis ac tellus. Aliquam nunc diam, ultrices et cursus ac, ornare mollis tellus. Ut venenatis lacus nec risus eleifend placerat. 
        ...
        \begin{figure}[H]
  		  \centering
  		  \includegraphics[width=8cm]{MEDIUM-GA_Size_Data}
  ...
  \subsection{Comparison Between the Different Searches}
    ...
    \begin{figure}[H]
	  ...
	  \fbox{\includegraphics[width=8cm]{SMALL-TYPE2_FullAverageStats}}
	...
	\begin{figure}[H]
  	  ...
  	  \setlength\fboxsep{0pt}
	  \setlength\fboxrule{0.5pt}
	  \fbox{\includegraphics[width=8cm]{MEDIUM-TYPE2_FullAverageStats}}
	...
	\begin{figure}[H]
  	  ...
  	  \setlength\fboxsep{0pt}
	  \setlength\fboxrule{0.5pt}
	  \fbox{\includegraphics[width=8cm]{HUGE-TYPE2_FullAverageStats}}
