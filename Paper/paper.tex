...
\section{Approach and Implementation}
  ...
  \subsection{Options for the Genetic Algorithm}
    \subsubsection{Scheduling Problem Instances}
      ...
      The package \emph{ScheduleInstanceGenerator} in our code repository manages the generation of 
      ...
      \hline \hline
       ...
       s		& $10^{182}$ & $10^{1840}$ & $10^{6695}$ & $10^{182}$ & $10^{1840}$ & $10^{6689}$ \\
      \hline 
	  \end{tabular} 
	  \end{small}
	  \end{center}
	  ...
	  Toronto's Faculty of Arts and Science \cite{website:uoftstats,website:artscistats}.
