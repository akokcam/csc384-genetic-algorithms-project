...
public class Main {
    ...
    private static final String FILENAME = "Instance Input Files\\super_huge_instance.txt";
    ...
    private static final int NUMTIMES = 8;
    private static final int NUMSTUDENTS = 21945;
    private static final int MAXCOURSESPERSTUDENT = 6;
    private static final int NUMROOMS = 43;
    private static final int NUMCOURSES = 603;
